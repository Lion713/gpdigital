...
<head>
    ...
    <title>Login User | Arsip Koran Digital</title>
            ...
            <div class="content-error">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <div>
                            <center>
                                <label>Belum punya Akun ? Silahkan Mendaftar </label>
                            </center>
                            <input type="button" onclick="location.href='user_daftar.php';" class="btn btn-success btn-block daftarbtn" value="Mendaftar">
                        </div>
