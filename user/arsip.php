            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    if(isset($_GET['kategori'])){
                        ...
                        $arsip = mysqli_query($koneksi,"SELECT * FROM arsip,kategori,petugas,user,pengajuan WHERE arsip_kategori=kategori_pengajuan and status_pengajuan=1 and pengajuan_user=user_id and user=$user and user=user_id and arsip_petugas=petugas_id and arsip_kategori=kategori_id and arsip_kategori='$kategori' ORDER BY arsip_id DESC");
                    }else{
                        $arsip = mysqli_query($koneksi,"SELECT * FROM arsip,kategori,petugas,user,pengajuan WHERE arsip_kategori=kategori_pengajuan and status_pengajuan=1 and pengajuan_user=user_id and user=$user and user=user_id and arsip_petugas=petugas_id and arsip_kategori=kategori_id ORDER BY arsip_id DESC");
                    }
