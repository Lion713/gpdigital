                    ...
                    ?>
                        <form method="post" action="pengajuan_update.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pengajuan" required="required" value="<?php echo $d['instansi_pengajuan']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="terbit" required="required" value="<?php echo $d['data_terbit']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="keterangan" required="required"><?php echo $d['keterangan_pengajuan']; ?></textarea>
                            </div>
